...
<template>
  <scroll-view class="viewport" @scrolltolower="onScrolltolower" scroll-y enable-back-to-top>
    ...
    <view class="profile" :style="{ paddingTop: safeAreaInsets!.top + 'px' }">
      ...
      <view class="overview" v-if="useMember.profile">
        <navigator url="/pagesMember/profile/profile" hover-class="none">
          <image class="avatar" mode="aspectFill" :src="useMember.profile.avatar"></image>
        </navigator>
        <view class="meta">
          <view class="nickname">
            {{ useMember.profile.nickname || useMember.profile.account }}
          </view>
    ...
    <view class="orders">
      <view class="title">
        我的订单
        <navigator class="navigator" url="/pagersOrder/list/list?type=0" hover-class="none">
      ...
      <view class="section">
        ...
        <navigator
          ...
          :key="item.type"
          :class="item.icon"
          :url="`/pagersOrder/list/list?type=${item.type}`"
          class="navigator"
          hover-class="none"
        >
          {{ item.text }}
